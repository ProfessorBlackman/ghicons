...
GHIcons is an open-source collection of Ghanaian cultural symbols — Adinkra, national emblems and more — built so developers can use Ghanaian visual language anywhere they build.
...
| Browse the icons | [ghicons.methuselah.site](https://ghicons.methuselah.site) |

---

## 🌍 About the Project

Ghana has a rich visual heritage — hundreds of Adinkra symbols, national emblems and cultural motifs that carry deep meaning. Most icon libraries ignore this entirely.
