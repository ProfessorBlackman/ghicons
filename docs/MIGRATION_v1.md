# Migration v1 — `ghicons` 0.0.x → 0.1.0

> The `v1` is the first guide in the series, not a GHIcons version. This guide
> takes you to `0.1.0`. The [index](MIGRATION.md) lists the rest.
